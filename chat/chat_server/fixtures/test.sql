...
INSERT INTO chat_agents(chat_id, name, type, adapter, model, prompt, args)
  VALUES (1, 'translation', 'proxy', 'test', 'llama3.2', 'If language is Chinese, translate to English, if language is English, translate to Chinese. Please reply with the translated content directly. No explanation is needed. Here is the content: ', '{}');
